...
<center>
<form action="dmsg.jsp">
<a href="userhome.jsp" class="w3-button w3-white w3-display-left">HOME</a><strong>SELECT DOCTOR HERE</strong><select name=dname class="w3-button w3-white">
<%
String uemail=(String)session.getAttribute("uemail");
ResultSet r2=DBConnect.getCons();
while(r2.next())
{
	if(r2.getString(4).equals(uemail))
	{
		%>
		<option value="<%= r2.getString(2) %>"><%= r2.getString(3) %></option>		
		<%
	}
}
%>
...
<form action="Dmsing" method="post">
